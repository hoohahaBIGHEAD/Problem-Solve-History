...
string UndergraduateStudent::getStudentInfo() {
...
float UndergraduateStudent::getGPA() {
	return ((this->majorCredit * this->majorGPA) + (this->minorCredit * this->minorGPA)) / (this->majorCredit + this->minorCredit);
}

int UndergraduateStudent::getTuition() {
	return ((this->majorCredit * 10) + (this->minorCredit) * 6);
}


// 생성자. 변수를 6개 받는다.
UndergraduateStudent::UndergraduateStudent(string name, int majorCredit, int minorCredit, float majorGPA, float minorGPA, string circle) {
	this->name = name;
...
string GraduateStudent::getStudentInfo() {
		return " - " +
			this->name + " " +
			to_string(this->majorCredit) + " " +
			to_string(this->minorCredit) + " " +
...
float GraduateStudent::getGPA() {
	return ((this->majorCredit * this->majorGPA) * 1.1 + (this->minorCredit * this->minorGPA) * 0.9) / (this->majorCredit + this->minorCredit);
}

int GraduateStudent::getTuition() {
	return ((this->majorCredit * 12) + (this->minorCredit) * 4);
}

// 생성자. 변수를 7개 받는다.
GraduateStudent::GraduateStudent(string name, int majorCredit, int minorCredit, float majorGPA, float minorGPA, string lab, string degreeProgram) {
	this->name = name;
	this->majorCredit = majorCredit;
	this->minorCredit = minorCredit;
	this->majorGPA = majorGPA;
...
//
/////////////////////////////////////////////////////////////////////////////
ScholarshipManagement::ScholarshipManagement(Student** student, int num_of_students) {
